...
<body>
    ...
    <div class="container-head">
        <div class="navline">
            ...
            <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
					                <a href="userview.php">Inicio</a>
            <a href="sectiontecnologia.php">Tecnología</a>
                <a href="sectiondeporte.php">Deporte</a>
                <a href="sectionropa.php">Ropa</a>
                <a href="../perfil_usuario/perfil.php">Editar perfil</a>
                <?php
                $username = $_SESSION['username'];


                $admin = "select * from users where username='" . $username . "'";
                ...
                if ($rol["usertype"] == "admin") {
                    ...
                    echo '<a href="adminhome.php" id="admin">Zona Admin</a>';
                }
    ...
    <div class="container-page">
        ...
        <div class="box_title_section">
            <p class="title_section"><b>SECCIÓN DE DEPORTE</b></p>
                ...
                <div class="box_product">
                    <div class="box_product_text">
                        <p class="preoduct_text"><b><?php
                                                    ...
                                                    $sql = "SELECT proname, price,image,id FROM product where id=35";
                                                    $result = $con->query($sql);
                ...
                <div class="box_product">
                    <div class="box_product_text">
                        <p class="preoduct_text"><b><?php
                                                    ...
                                                    $sql = "SELECT proname, price,image,id FROM product where id=36";
                                                    $result = $con->query($sql);
                ...
                <div class="box_product">
                    <div class="box_product_text">
                        <p class="preoduct_text"><b><?php
                                                    ...
                                                    $sql = "SELECT proname, price,image,id FROM product where id=37";
                                                    $result = $con->query($sql);
            ...
            <div class="box_product">
                    <div class="box_product_text">
                        <p class="preoduct_text"><b><?php
                                                    ...
                                                    $sql = "SELECT proname, price,image,id FROM product where id=38";
                                                    $result = $con->query($sql);
                ...
                <div class="box_product">
                    <div class="box_product_text">
                        <p class="preoduct_text"><b><?php
                                                    ...
                                                    $sql = "SELECT proname, price,image,id FROM product where id=39";
                                                    $result = $con->query($sql);
                ...
                <div class="box_product">
                    <div class="box_product_text">
                        <p class="preoduct_text"><b><?php
                                                    ...
                                                    $sql = "SELECT proname, price,image,id FROM product where id=40";
                                                    $result = $con->query($sql);
