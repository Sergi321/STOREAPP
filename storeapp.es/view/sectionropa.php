...
<body>
    ...
    <div class="container-page">
        ...
        <div class="box_title_section">
            <p class="title_section"><b>SECCIÓN DE ROPA</b></p>
                ...
                <div class="box_product">
                    <div class="box_product_text">
                        <p class="preoduct_text"><b><?php
                                                    ...
                                                    $sql = "SELECT proname, price,image,id FROM product where id=29";
                                                    $result = $con->query($sql);
                ...
                <div class="box_product">
                    <div class="box_product_text">
                        <p class="preoduct_text"><b><?php
                                                    ...
                                                    $sql = "SELECT proname, price,image,id FROM product where id=30";
                                                    $result = $con->query($sql);
                ...
                <div class="box_product">
                    <div class="box_product_text">
                        <p class="preoduct_text"><b><?php
                                                    ...
                                                    $sql = "SELECT proname, price,image,id FROM product where id=31";
                                                    $result = $con->query($sql);
            ...
            <div class="box_product">
                    <div class="box_product_text">
                        <p class="preoduct_text"><b><?php
                                                    ...
                                                    $sql = "SELECT proname, price,image,id FROM product where id=32";
                                                    $result = $con->query($sql);
                ...
                <div class="box_product">
                    <div class="box_product_text">
                        <p class="preoduct_text"><b><?php
                                                    ...
                                                    $sql = "SELECT proname, price,image,id FROM product where id=33";
                                                    $result = $con->query($sql);
                ...
                <div class="box_product">
                    <div class="box_product_text">
                        <p class="preoduct_text"><b><?php
                                                    ...
                                                    $sql = "SELECT proname, price,image,id FROM product where id=34";
                                                    $result = $con->query($sql);
