                ...
                <div class="box_product">
                    <div class="box_product_text">
                        <p class="preoduct_text"><b><?php
                                                    ...
                                                    $sql = "SELECT proname, price,image,id FROM product where id=41";
                                                    $result = $con->query($sql);
                ...
                <div class="box_product">
                    <div class="box_product_text">
                        <p class="preoduct_text"><b><?php
                                                    ...
                                                    $sql = "SELECT proname, price,image,id FROM product where id=28";
                                                    $result = $con->query($sql);
                ...
                <div class="box_product">
                    <div class="box_product_text">
                        <p class="preoduct_text"><b><?php
                                                    ...
                                                    $sql = "SELECT proname, price,image,id FROM product where id=22";
                                                    $result = $con->query($sql);
