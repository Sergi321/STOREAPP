<?php
    ...
    $nuevo_path="../../assets/productos/tecnologia/".$name;
    ...
    if($_POST['name'] != null && $_POST['amount'] != null ){
        $sql = "INSERT INTO product (proname,amount,price,image) VALUES ('". trim($_POST['name']). "','". trim($_POST['amount']). "','". trim($_POST['price'])."','".$nuevo_path."')";
