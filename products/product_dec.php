...
<div class="container-head">
        <div class="navline">
            ...
            <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
                ...
                <a href="#">Deporte</a>
                <a href="../view/sectionropa.php">Ropa</a>
...
$id = $_POST['id'];
        ...
        <p class="text_product"> Stock: <?php echo $stock;?></p>
       
            <form action="cart/carrito.php" method="post">
                <input type="number" name="quantity" placeholder="Catidad" required>
				<input type="hidden" value="<?php echo $id ?>" name="id" />
						<input type="hidden" value="<?php echo $name_product ?>" name="name_product" />
                        <input type="hidden" value="<?php echo $stock?>" name="amount" />
