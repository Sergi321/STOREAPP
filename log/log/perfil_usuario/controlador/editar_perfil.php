<?php
    ...
    $nuevo_path="C:/Users/DAW2/Desktop/log/assets/picture_users/".$name;
    ...
    echo "<br> Tamanio: ".$_FILES['img_up']["size"]." bytes";      //tamaño
        ...
        $sql = "UPDATE users SET username = '" . trim($_POST['username']) . "' ,email = '" . trim($_POST['email']) . "',password = '" . trim(md5($_POST['password'])) . "',ruta_img = '" . $ruta_local . "' WHERE id = '" . $_POST['id'] . "'";
        if($con->query($sql)){
