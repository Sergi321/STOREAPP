...
<p class="title_product">Sección móviles</p>
            ...
            <p class="title_product">Sección transporte</p>
            <div class="contenedor_row">
                <div class="box_product">
                    <div class="box_product_text">
                        <p class="preoduct_text"><b><?php
                ...
                <div class="box_product">
                    <div class="box_product_text">
                        <p class="preoduct_text"><b><?php
                                                    ...
                                                    $sql = "SELECT proname, price,image FROM product where id=22";
                                                    $result = $con->query($sql);
                                                    if ($row = $result->fetch_assoc()) {
                                                        echo  $row["proname"] . ": " . $row["price"] . "€";
                                                        echo "<br><img class='img_pr'src=" . $row["image"] . ">";
                ...
                <div class="box_product">
                    <div class="box_product_text">
                        <p class="preoduct_text"><b><?php
                                                    ...
                                                    $sql = "SELECT proname, price,image FROM product where id=23";
                                                    $result = $con->query($sql);
                                                    if ($row = $result->fetch_assoc()) {
                                                        echo  $row["proname"] . ": " . $row["price"] . "€";
                                                        echo "<br><img class='img_pr'src=" . $row["image"] . ">";
